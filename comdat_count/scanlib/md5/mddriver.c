/* Code extracted directly from RFC1321 "The MD5 Message-Digest Algorithm" and
 * modernized for C99.
 */
...
static void MDString (char const *);
static void MDTimeTrial (void);
static void MDTestSuite (void);
static void MDFile (char const *);
...
static void MDString (char const *string) {
    ...
    MDInit (&context);
    MDUpdate (&context, (unsigned char const *) string, len);
